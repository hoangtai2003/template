...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to admin
	...
	register: function(id, client) {
		// register new admin to receive events
	...
	Client: function(elem) {
		// constructor for new simple upload admin
		this.handlers = {};
		...
		// register admin with singleton to receive flash events
